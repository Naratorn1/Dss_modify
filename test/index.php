<?php
  $age = $_POST['age'];
  $income = $_POST['income'];
  $using_youtube = $_POST['using_youtube'];
  $channel = $_POST['channel'];
  $ads_noskip = $_POST['ads_noskip'];
  $ads_skip = $_POST['ads_skip'];
  $pay = $_POST['pay'];
  echo "age".$age;
  echo "income".$income;
  echo "using_youtube".$using_youtube;
  echo "channel".$channel;
  echo "ads_noskip".$ads_noskip;
  echo "ads_skip".$ads_skip;
  echo "pay".$pay;
  $d = (rand(0,100)/100);
  $s = 1-$d;
...
<!-- partial -->
  ...
  $("#doughnutChart").drawDoughnutChart([
    { title: "ไม่ควรสมัคร",value : <?php echo $d ?>,  color: "#6DBCDB" },
    { title: "ควรสมัคร", value:  <?php echo $s ?>,   color: "#A04E3D" },
